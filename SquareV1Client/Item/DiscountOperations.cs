...
namespace MeyerCorp.Square.V1.Item
{
    public class DiscountOperations : Operations, IDiscountOperations
    {
        ...
        public Task<HttpOperationResponse<Discount>> PostWithHttpMessagesAsync(string locationId, Discount value, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            var uri = GetUri(locationId);
        ...
        public Task<HttpOperationResponse<Discount>> PutWithHttpMessagesAsync(string locationId, string id, Discount value, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
