...
namespace MeyerCorp.Square.V1
{
    ...
    public partial interface ILocationOperations 
    {
        ...
        /// The cancellation token.
        /// </param>
        Task<HttpOperationResponse<Merchant>> GetWithHttpMessagesAsync(string employeeId, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken), Uri uri = null);
