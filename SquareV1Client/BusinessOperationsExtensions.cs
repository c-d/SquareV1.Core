...
namespace MeyerCorp.Square.V1
{
    public static partial class BusinessOperationsExtensions
    {
        ...
        /// </param>
        public static Merchant Get(this IBusinessOperations operations, string locationId = null)
        {
        ...
        /// </param>
        public static async Task<Merchant> GetAsync(this IBusinessOperations operations, string locationId = null, CancellationToken cancellationToken = default(CancellationToken))
        {
